...
h1{
    ...
    background-image: url(<?php echo HOME_DOMAIN;?>public/images/404.jpg);
...
<body>
    <h1></h1>
    <h2><em><span class="STYLE1">404 Error&nbsp;&nbsp; </span></em>: 您所查找的页面不存在,可能已被删除或您输错了网址

!</h2>
<p class="link">
        <a href="http://www.dreamma.cn">&#9666;返回首页</a>
