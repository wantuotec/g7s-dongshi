...
<script type="text/javascript">
    ...
    var add = function () {
        ...
        $.post('<?php echo HOME_DOMAIN; ?>adm_mood/add_mood', $('form').serialize(), function (response) {
            if (true === response.success) {
                if ($.BKD.confirm('心情添加成功！是否继续添加？')) {
                    $.BKD.redirect('<?php echo HOME_DOMAIN; ?>adm_mood/add_mood');
                } else {    
                    $.BKD.refresh_parent('<?php echo HOME_DOMAIN; ?>adm_mood');
                } 
            } else {
