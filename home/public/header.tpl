...
<body>
 ...
 <header>
    ...
    <nav class="topnav" id="topnav">
        ...
        <a <?php if($current_title && $current_title == 'article'){ echo "class='topnav_current'"; }?> href="<?php echo HOME_DOMAIN;?>article/index"><span>发现生活</span><span class="en">Article</span></a>
        <a <?php if($current_title && $current_title == 'mood'){ echo "class='topnav_current'"; }?> href="<?php echo HOME_DOMAIN;?>mood/index"><span>随笔杂记</span><span class="en">Mood</span></a>
